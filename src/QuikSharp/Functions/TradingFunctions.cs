...
namespace QUIKSharp.Functions
{
    ...
    public class TradingFunctions : FunctionsBase, ITradingFunctions
    {
        ...
        /// </summary>
        public Task<List<DepoLimitEx>> GetDepoLimits(CancellationToken cancellationToken) => QuikService.SendAsync<List<DepoLimitEx>>(new Message<string>("", "get_depo_limits"));

        /// <summary>
        /// Возвращает список записей из таблицы 'Лимиты по бумагам', отфильтрованных по коду инструмента.
        /// </summary>
        public Task<List<DepoLimitEx>> GetDepoLimits(string secCode, CancellationToken cancellationToken) => QuikService.SendAsync<List<DepoLimitEx>>(new Message<string>(secCode, "get_depo_limits"));
